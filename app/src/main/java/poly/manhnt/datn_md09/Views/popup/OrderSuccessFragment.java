...
public class OrderSuccessFragment extends DialogFragment {
    ...
    public OrderSuccessFragment(OnButtonAcceptClickListener listener) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (context != null) {
            ...
            dialog.setContentView(R.layout.layout_dialog_order_success);
            ...
            dialog.findViewById(R.id.btn_accept).setOnClickListener(v -> {
                dialog.dismiss();
                listener.onOrderSuccessButtonAcceptClick();
            });
    ...
    public interface OnButtonAcceptClickListener {
        void onOrderSuccessButtonAcceptClick();
    }
}
